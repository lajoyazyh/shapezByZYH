...
"image: url(:/images/resource/images/cutter.png);"));
        ...
        pushButtonShop->setGeometry(QRect(640, 580, 91, 71));
        pushButtonShop->setStyleSheet(QString::fromUtf8("image: url(:/images/resource/images/shop.png);"));
        pushButton = new QPushButton(centralwidget);
        pushButton->setObjectName("pushButton");
        pushButton->setGeometry(QRect(780, 580, 91, 71));
        pushButton->setStyleSheet(QString::fromUtf8("image: url(:/images/resource/images/mutiplier.png);"));
        pushButton_2 = new QPushButton(centralwidget);
        pushButton_2->setObjectName("pushButton_2");
        pushButton_2->setGeometry(QRect(780, 760, 91, 71));
        pushButton_2->setStyleSheet(QString::fromUtf8("image: url(:/images/resource/images/save.png);"));
