...
public:
    ...
    void setupUi(QMainWindow *MainScene)
    {
        ...
        pushButton_2->setGeometry(QRect(350, 570, 301, 61));
        QFont font1;
        font1.setFamilies({QString::fromUtf8("IQYHT")});
    ...
    void retranslateUi(QMainWindow *MainScene)
    {
        ...
        pushButton_2->setText(QCoreApplication::translate("MainScene", "Open Local File", nullptr));
    } // retranslateUi
